...
**Exercise.**
Why wasn't it an issue if we publish all the keys at the outset "in the official channel"? Reflect on the definition of attack protocol.
